...
//"    float4 color = tex2D(samCur, ( vIn.tex - offsScaleCur.xy ) * offsScaleCur.zw ); \n"
//"    float4 color = tex2D(samCur, vIn.tex ); \n"
//"    float4 color = float4(vIn.tex.x,vIn.tex.y,0,1 ); \n"
//"    float4 color = float4(offsScaleCur.x,offsScaleCur.y,0,1 ); \n"
"    return color;                               \n"
"}                                               \n"
"                                                \n"
...
"{                                               \n"
"    float4 color = tex2DBC(samContent, vIn.tex ); \n"
"    return color;                               \n"
"}                                               \n"
"                                                \n"
...
"		}                                           \n"
"		tex.xy/= tex.z;\n"
"		vOut = tex2DBC( samContent, tex.xy );  \n"
"		vCur = tex2D( samCur, (tex.xy - offsScaleCur.xy)*offsScaleCur.zw );  \n"
"		vOut.rgb = vCur.a * vCur.rgb + vOut.rgb * ( 1.0 - vCur.a );\n"
"		if( bBorder.y > 0.5 )                      \n"
"			vOut.rgb*= blend.rgb;			        \n"
...
"    output.tex-= offsScale.xy;                                 \n"
"    output.tex*= offsScale.zw;                                 \n"
"    output.tex = input.Tex;								\n"
"    return output;												\n"
"}																\n"
"                                                \n"
...
"	 color = texContent.Sample( samLin, vIn.tex ); \n"
"    return color;                               \n"
"}                                               \n"
"                                                \n"
...
"		}                                           \n"
"		tex.xy/= tex.z;\n"
"		vOut = texContent.Sample( samLin, tex.xy );  \n"
...
"{                                               \n"
"    float4 color = tex2DBC( texContent, vIn.tex ); \n"
"    return color;                               \n"
"}                                               \n"
"                                                \n"
...
"		}                                           \n"
"		tex.xy/= tex.z;\n"
"		vOut = tex2DBC( texContent, tex.xy );  \n"
"		vCur = texCur.Sample( samLin, (tex.xy - offsScaleCur.xy)*offsScaleCur.zw );  \n"
"		vOut.rgb = vCur.a * vCur.rgb + vOut.rgb * ( 1.0 - vCur.a );\n"
"		if( bBorder.y > 0.5 )                      \n"
"			vOut.rgb*= blend.rgb;			        \n"
